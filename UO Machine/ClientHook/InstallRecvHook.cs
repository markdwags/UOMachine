        ...
        public static void InstallRecvHook( ClientInfo ci )
        {
            switch (ci.RecvHookType)
            {
                ...
                case 1:
                    ...
                    int jmpStart1 = caveAddress1 + (18 + 5);
                    ...
                    Buffer.BlockCopy( firstInstruction, 0, newCode1, (13 + 5), 5 );
                    Buffer.BlockCopy( firstInstruction, 0, newCode1, (31), 5 );
                    Buffer.BlockCopy( call1, 0, newCode1, 5, 5 );
                    Buffer.BlockCopy( jump1, 0, newCode1, (18 + 5), 5 );
